...
export default function LandingHero({ onAnimationComplete }) {
  useEffect(() => {
    ...
    tl.set(".preloader", { opacity: 0 })
      ...
      .to(".pill-fill", { opacity: 0.08, duration: 0.6 }, "<")
      .to(
        ".preloader",
...
>
        <div
          className="pill relative overflow-hidden rounded-[56px] border border-white/5 bg-[#1b1816] flex items-center justify-center"
          style={{
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-4 sm:px-6 md:px-10 lg:px-10 xl:px-12">
        <div className="max-w-[95%] sm:max-w-2xl md:max-w-3xl lg:max-w-5xl mx-auto text-center md:text-left">
          <h1 className="hero-title text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight mb-4 sm:mb-6">
