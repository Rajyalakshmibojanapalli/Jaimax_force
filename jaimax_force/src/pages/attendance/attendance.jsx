...
const isCheckedOut = Boolean(todayRecord?.checkOut?.time);
 ...
 return (
  ...
  <div className="flex items-center gap-2">
      ...
      {/* Check-In / Check-Out Buttons */}
       <div className="flex flex-col xs:flex-row gap-3 w-full sm:w-auto">
        <button
          ...
          className={`flex items-center justify-center gap-2 px-5 py-2.5 rounded-md font-semibold text-black bg-[#18a04a] hover:bg-[#14953f] transition disabled:opacity-60 ${
            isCheckedIn
              ? "bg-green-500 cursor-not-allowed"
              : "bg-[#18a04a] hover:bg-[#14953f]"
          }`}
        >
          <Check size={16} />
          {manualCheckIn ? "Checking In..." : isCheckedIn ? "Checked In" : "Check-In"}
        </button>
        ...
        >
          <X size={16} />
          {manualCheckOut ? "Checking Out..." : isCheckedOut ? "Checked Out" : "Check-Out"}
        </button>
      </div>
    </div>
    ...
    {/* Table */}
    <div className="overflow-x-auto rounded-xl border border-[#2a2a2a] bg-[#141414] shadow-sm">
      <table className="w-full text-xs sm:text-sm">
        <thead className="bg-[#1e1e1e] text-[#FFD700]">
          <tr>
